...
desc: (legacy @quasar/app-webpack v3) The Quasar CLI list of commands when developing or building a hybrid mobile app with Cordova.
---
...
::: tip
Also check `getCordovaBuildParams()` and `getCordovaBuildOutputFolder()` (quasar.config > cordova options) from [Configuring Cordova](/quasar-cli-webpack-v3/developing-cordova-apps/configuring-cordova#quasar-config-file) page.
:::
