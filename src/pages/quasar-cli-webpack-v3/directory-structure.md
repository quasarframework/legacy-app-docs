...
desc: (legacy @quasar/app-webpack v3) The structure of a Quasar app with explanations for each folder and file.
scope:
  tree:
    l: "."
    c:
    - l: public
      ...
      url: "/quasar-cli-webpack-v3/handling-assets#static-assets-public"
    - l: src
      c:
      - l: assets/
        e: Dynamic assets (processed by Vite)
        url: "/quasar-cli-webpack-v3/handling-assets#regular-assets-src-assets"
      - l: components/
      ...
      - l: boot/
        ...
        url: "/quasar-cli-webpack-v3/boot-files"
      - l: router
        e: Vue Router
        url: "/quasar-cli-webpack-v3/routing"
        c:
        - l: index.js
      ...
      - l: stores
        ...
        url: "/quasar-cli-webpack-v3/state-management-with-pinia"
        c:
        - l: index.js
      ...
      - l: store
        ...
        url: "/quasar-cli-webpack-v3/state-management-with-vuex"
        c:
        - l: index.js
    ...
    - l: src-ssr/
      ...
      url: "/quasar-cli-webpack-v3/developing-ssr/introduction"
    - l: src-pwa/
      e: PWA specific code (like Service Worker)
      url: "/quasar-cli-webpack-v3/developing-pwa/introduction"
    - l: src-capacitor/
      e: Capacitor generated folder used to create Mobile Apps
      url: "/quasar-cli-webpack-v3/developing-capacitor-apps/introduction"
    - l: src-cordova/
      e: Cordova generated folder used to create Mobile Apps
      url: "/quasar-cli-webpack-v3/developing-cordova-apps/introduction"
    - l: src-electron/
      e: Electron specific code (like "main" thread)
      url: "/quasar-cli-webpack-v3/developing-electron-apps/introduction"
    - l: src-bex/
      e: BEX (browser extension) specific code (like "main" thread)
      url: "/quasar-cli-webpack-v3/developing-browser-extensions/introduction"
    - l: dist
    ...
    - l: quasar.config.js
      ...
      url: "/quasar-cli-webpack-v3/quasar-config-file"
    - l: ".gitignore"
      e: GIT ignore paths
