...
desc: (legacy @quasar/app-webpack v3) The ssrContext Object in Quasar SSR
---
...
Among other places, it is supplied as parameter to [boot files](/quasar-cli-webpack-v3/boot-files), to the [Vuex store](/quasar-cli-webpack-v3/state-management-pinia-vuex) and [Vue Router](/quasar-cli-webpack-v3/routing) initialization functions, and to the [preFetch](/quasar-cli-webpack-v3/prefetch-feature) method:
