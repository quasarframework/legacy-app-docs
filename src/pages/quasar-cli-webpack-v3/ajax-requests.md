---
title: Ajax Requests
desc: (legacy @quasar/app-webpack v3) Using Axios for fetching data in a Quasar app.
---
...
::: tip
Be sure to check out [Prefetch Feature](/quasar-cli-webpack-v3/prefetch-feature) if you are using Quasar CLI.
:::
