---
title: Boot files
desc: (legacy @quasar/app-webpack v3) Managing your startup code in a Quasar app.
related:
...
| `ssrContext` | Available only on server-side, if building for SSR. [More info](/quasar-cli-webpack-v3/developing-ssr/ssr-context) |
