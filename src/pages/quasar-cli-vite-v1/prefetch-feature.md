...
desc: (legacy @quasar/app-vite v1) How to prefetch data and initialize your Vuex store, validate the route and redirect to another page in a Quasar app.
related:
...
### LoadingBar
When you add Quasar [LoadingBar](https://v2.quasar.dev/quasar-plugins/loading-bar) plugin to your app, Quasar CLI will use it while it runs the preFetch hooks by default.

### Loading
There's also the possibility to use Quasar [Loading](https://v2.quasar.dev/quasar-plugins/loading) plugin. Here's an example:
