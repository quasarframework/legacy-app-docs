...
desc: (legacy @quasar/app-vite v1) Where, how and what you can configure in a Quasar CLI with Vite app.
---
...
* [Boot Files](/quasar-cli-vite-v1/boot-files) list (that determines order of execution too) -- which are files in `/src/boot` that tell how your app is initialized before mounting the root Vue component
...
More on [Boot Files](/quasar-cli-vite-v1/boot-files).
...
More on the [PreFetch Feature](/quasar-cli-vite-v1/prefetch-feature) page.
...
More on the [Linter](/quasar-cli-vite-v1/linter) page.
...
- [Quasar Language Packs](https://v2.quasar.dev/options/quasar-language-packs)
- [Quasar Icon Sets](https://v2.quasar.dev/options/quasar-icon-sets)
- [Quasar CSS Addons - Flex](https://v2.quasar.dev/layout/grid/introduction-to-flexbox#flex-addons)
- [Quasar CSS Addons - Spacing](https://v2.quasar.dev/style/spacing#flex-addons)

### animations

More on [CSS animations](https://v2.quasar.dev/options/animations).
...
interface QuasarStaticBuildConfiguration {
   ...
   *
   * @see https://v2.quasar.dev/quasar-cli-vite-v1/handling-vite#vite-vue-plugin-options
   */
   ...
   * Vite plugins
   *
   * @see https://v2.quasar.dev/quasar-cli-vite-v1/handling-vite#adding-vite-plugins
   *
   * @example
   * [
  ...
  /**
   * @see https://v2.quasar.dev/quasar-cli-vite-v1/handling-vite#folder-aliases
   *
   * @example
   * {
   *   // import { ... } from 'locales/...'
   ...
   *
   * @see https://v2.quasar.dev/quasar-cli-vite-v1/handling-process-env
   *
...
- [Vite Vue Plugin options](/quasar-cli-vite-v1/handling-vite#vite-vue-plugin-options)
- [Adding Vite plugins](/quasar-cli-vite-v1/handling-vite#adding-vite-plugins)
- [Folder Aliases](/quasar-cli-vite-v1/handling-vite#folder-aliases)
- [Handling Process Env](/quasar-cli-vite-v1/handling-process-env)
...
| --- | --- | --- |
| cordova | Object | Cordova specific [config](/quasar-cli-vite-v1/developing-cordova-apps/configuring-cordova). |
| capacitor | Object | Quasar CLI Capacitor specific [config](/quasar-cli-vite-v1/developing-capacitor-apps/configuring-capacitor). |
| pwa | Object | PWA specific [config](/quasar-cli-vite-v1/developing-pwa/configuring-pwa). |
| ssr | Object | SSR specific [config](/quasar-cli-vite-v1/developing-ssr/configuring-ssr). |
| electron | Object | Electron specific [config](/quasar-cli-vite-v1/developing-electron-apps/configuring-electron). |
| bex | Object | BEX specific [config](/quasar-cli-vite-v1/developing-browser-extensions/configuring-bex). |
...
Please refer to [Adding to process.env](/quasar-cli-vite-v1/handling-process-env#adding-to-process-env) section in our docs.

### Adding Vite plugins

Please refer to the [Handling Vite](/quasar-cli-vite-v1/handling-vite#adding-vite-plugins) page.
