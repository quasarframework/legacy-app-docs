...
desc: (legacy @quasar/app-vite v1) Introduction on one of the technologies behind Quasar hybrid mobile apps.
---
...
You can hook into the native device APIs by using [Cordova Plugins](/quasar-cli-vite-v1/developing-cordova-apps/cordova-plugins).
