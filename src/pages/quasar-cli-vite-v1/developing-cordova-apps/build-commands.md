...
desc: (legacy @quasar/app-vite v1) The Quasar CLI list of commands when developing or building a hybrid mobile app with Cordova.
---
...
::: tip
Also check `getCordovaBuildParams()` and `getCordovaBuildOutputFolder()` (quasar.config > cordova options) from [Configuring Cordova](/quasar-cli-vite-v1/developing-cordova-apps/configuring-cordova#quasar-config-file) page.
:::
