...
desc: (legacy @quasar/app-vite v1) The ssrContext Object in Quasar SSR
---
...
Among other places, it is supplied as parameter to [boot files](/quasar-cli-vite-v1/boot-files), to the [Vuex store](/quasar-cli-vite-v1/state-management-pinia-vuex) and [Vue Router](/quasar-cli-vite-v1/routing) initialization functions, and to the [preFetch](/quasar-cli-vite-v1/prefetch-feature) method:
