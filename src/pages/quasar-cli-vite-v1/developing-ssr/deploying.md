---
title: Deploying SSR
desc: (legacy @quasar/app-vite v1) How to publish a Quasar server-side rendered app.
---
...
If you are deploying to a Serverless service, then please read about [SSR Webserver](/quasar-cli-vite-v1/developing-ssr/ssr-webserver) on how to prepare for it.
