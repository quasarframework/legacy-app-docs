---
title: SSR Webserver
desc: (legacy @quasar/app-vite v1) Configuring the Quasar SSR webserver for different platforms, including a serverless architecture.
---
 ...
 * https://v2.quasar.dev/quasar-cli-vite-v1/developing-ssr/ssr-webserver
 *
...
* This is usually not the place to add middlewares (but you can do it). Add middlewares by using the [SSR Middlewares](/quasar-cli-vite-v1/developing-ssr/ssr-middleware) instead. You can configure SSR Middlewares to run only for dev or only for production too.
:::
