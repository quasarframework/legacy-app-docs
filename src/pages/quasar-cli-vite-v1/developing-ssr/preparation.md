...
desc: (legacy @quasar/app-vite v1) How to add SSR mode with Quasar CLI.
related:
...
A new folder will appear in your project folder (which is explained in detail on the [Configuring SSR](/quasar-cli-vite-v1/developing-ssr/configuring-ssr) page):
