...
desc: (legacy @quasar/app-vite v1) How to use analytics in a Quasar hybrid mobile app with Capacitor.
---
...
## Prerequisites
* Make sure all your routes have a name and path parameter specified. Otherwise, they cannot be posted to the `ga.logPage` function. Please refer to [Routing](/quasar-cli-vite-v1/routing) for more info on routing.
