  ...
  tree:
    ...
    c:
      - l: public
        ...
        url: '/quasar-cli-vite-v2/handling-assets#static-assets-public'
      - l: src
        c:
          - l: assets/
            e: Dynamic assets (processed by Vite)
            url: '/quasar-cli-vite-v2/handling-assets#regular-assets-src-assets'
          - l: components/
          ...
          - l: boot/
            ...
            url: '/quasar-cli-vite-v2/boot-files'
          - l: router
            e: Vue Router
            url: '/quasar-cli-vite-v2/routing'
            c:
              - l: index.js
          ...
          - l: stores
            e: Pinia Stores
            url: '/quasar-cli-vite-v2/state-management-with-pinia'
            c:
              - l: index.js
      ...
      - l: src-ssr/
        ...
        url: '/quasar-cli-vite-v2/developing-ssr/introduction'
      - l: src-pwa/
        e: PWA specific code (like Service Worker)
        url: '/quasar-cli-vite-v2/developing-pwa/introduction'
      - l: src-capacitor/
        e: Capacitor generated folder used to create Mobile Apps
        url: '/quasar-cli-vite-v2/developing-capacitor-apps/introduction'
      - l: src-cordova/
        e: Cordova generated folder used to create Mobile Apps
        url: '/quasar-cli-vite-v2/developing-cordova-apps/introduction'
      - l: src-electron/
        e: Electron specific code (like "main" thread)
        url: '/quasar-cli-vite-v2/developing-electron-apps/introduction'
      - l: src-bex/
        e: BEX (browser extension) specific code (like "main" thread)
        url: '/quasar-cli-vite-v2/developing-browser-extensions/introduction'
      - l: dist
      ...
      - l: quasar.config.js
        ...
        url: '/quasar-cli-vite-v2/quasar-config-file'
      - l: index.html
