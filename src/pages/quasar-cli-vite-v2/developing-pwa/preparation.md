...
desc: (legacy @quasar/app-vite v2) How to add PWA mode with Quasar CLI.
related:
...
A new folder will appear in your project folder (which is explained in detail on the [Configuring PWA](/quasar-cli-vite-v2/developing-pwa/configuring-pwa) page):
