...
- [Boot Files](/quasar-cli-vite-v2/boot-files) list (that determines order of execution too) -- which are files in `/src/boot` that tell how your app is initialized before mounting the root Vue component
...
More on [Boot Files](/quasar-cli-vite-v2/boot-files).
...
More on the [PreFetch Feature](/quasar-cli-vite-v2/prefetch-feature) page.
...
interface QuasarBuildConfiguration {
   ...
   *
   * @see https://v2.quasar.dev/quasar-cli-vite-v2/handling-vite#vite-vue-plugin-options
   */
  viteVuePluginOptions?: VuePluginOptions;
  /**
   * Vite plugins
   *
   * @see https://v2.quasar.dev/quasar-cli-vite-v2/handling-vite#adding-vite-plugins
   *
   * @example
   * // ESM
  ...
  /**
   * @see https://v2.quasar.dev/quasar-cli-vite-v2/handling-vite#folder-aliases
   *
   * @example
   * {
   *   // import { ... } from 'locales/...'
   ...
   *
   * @see https://v2.quasar.dev/quasar-cli-vite-v2/handling-process-env
   *
...
- [Vite Vue Plugin options](/quasar-cli-vite-v2/handling-vite#vite-vue-plugin-options)
- [Adding Vite plugins](/quasar-cli-vite-v2/handling-vite#adding-vite-plugins)
- [Folder Aliases](/quasar-cli-vite-v2/handling-vite#folder-aliases)
- [Handling Process Env](/quasar-cli-vite-v2/handling-process-env)
...
| --------- | ------ | --------------------------------------------------------------------------------------------------------- |
| cordova   | Object | Cordova specific [config](/quasar-cli-vite-v2/developing-cordova-apps/configuring-cordova).                  |
| capacitor | Object | Quasar CLI Capacitor specific [config](/quasar-cli-vite-v2/developing-capacitor-apps/configuring-capacitor). |
| pwa       | Object | PWA specific [config](/quasar-cli-vite-v2/developing-pwa/configuring-pwa).                                   |
| ssr       | Object | SSR specific [config](/quasar-cli-vite-v2/developing-ssr/configuring-ssr).                                   |
| electron  | Object | Electron specific [config](/quasar-cli-vite-v2/developing-electron-apps/configuring-electron).               |
| bex       | Object | BEX specific [config](/quasar-cli-vite-v2/developing-browser-extensions/configuring-bex).                    |

## Examples

### Setting env for dev/build

Please refer to [Adding to process.env](/quasar-cli-vite-v2/handling-process-env#adding-to-process-env) section in our docs.

### Adding Vite plugins

Please refer to the [Handling Vite](/quasar-cli-vite-v2/handling-vite#adding-vite-plugins) page.
