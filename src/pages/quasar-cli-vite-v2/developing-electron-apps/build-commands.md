...
Check how you can tweak Esbuild config Object for the Main Process and the Preload script on the [Configuring Electron](/quasar-cli-vite-v2/developing-electron-apps/configuring-electron) page.
...
It builds your app for production and then uses @electron/packager to pack it into an executable. Check how to configure this on [Configuring Electron](/quasar-cli-vite-v2/developing-electron-apps/configuring-electron) page.
