...
desc: (legacy @quasar/app-vite v2) The things you should know about security in a Quasar desktop app.
---
...
1.  Make sure that you leave `webPreferences` > `contextIsolation` set to `true`. Use the [preload script](/quasar-cli-vite-v2/developing-electron-apps/electron-preload-script) to inject only must-have APIs to the renderer thread.
