...
desc: (legacy @quasar/app-vite v2) How to enable support for TypeScript in a Quasar app.
related:
  - /quasar-cli-vite-v2/quasar-config-file
  - /quasar-cli-vite-v2/linter
---
...
You might want to check the requirements for it [here](/quasar-cli-vite-v2/linter).
...
If you are using [PWA mode](/quasar-cli-vite-v2/developing-pwa/introduction), make the following modifications to your project, and create any files that do not exist:
...
If you are using [Electron mode](/quasar-cli-vite-v2/developing-electron-apps/introduction), add the section below to your project.
