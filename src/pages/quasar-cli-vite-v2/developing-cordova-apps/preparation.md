...
desc: (legacy @quasar/app-vite v2) What you need to do before developing a Quasar hybrid mobile app with Cordova.
---
...
You will be able to run the app on your mobile device if you have one, or through the emulator. See [Mobile App Build Commands > Developing](/quasar-cli-vite-v2/developing-cordova-apps/build-commands#developing) for more information.
