...
desc: (legacy @quasar/app-vite v2) The Quasar CLI list of commands when developing or building a hybrid mobile app with Cordova.
---
...
::: tip
Also check `getCordovaBuildParams()` and `getCordovaBuildOutputFolder()` (quasar.config > cordova options) from [Configuring Cordova](/quasar-cli-vite-v2/developing-cordova-apps/configuring-cordova#quasar-config-file) page.
:::
