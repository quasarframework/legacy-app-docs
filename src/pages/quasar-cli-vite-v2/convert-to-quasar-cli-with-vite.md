...
desc: (legacy @quasar/app-vite v2) How to convert a Quasar CLI with Webpack project to a Quasar CLI with Vite one.
---
...
The following props are detailed in the [quasar.config file](/quasar-cli-vite-v2/quasar-config-file) page.
...
If you are using ESLint, you might want to check the requirements for it [here](/quasar-cli-vite-v2/linter).
