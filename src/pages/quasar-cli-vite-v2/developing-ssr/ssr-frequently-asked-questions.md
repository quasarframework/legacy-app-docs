...
The `ssrContext` is available in the [Boot Files](/quasar-cli-vite-v2/boot-files) or the [PreFetch Feature](/quasar-cli-vite-v2/prefetch-feature), where it is supplied as a parameter.
...
Also a good idea is to read the [Writing Universal Code](/quasar-cli-vite-v2/developing-ssr/writing-universal-code) documentation page.
