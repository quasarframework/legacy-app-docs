...
desc: (legacy @quasar/app-vite v2) The ssrContext Object in Quasar SSR
---
...
Among other places, it is supplied as parameter to [boot files](/quasar-cli-vite-v2/boot-files), to the [Pinia instance](/quasar-cli-vite-v2/state-management-with-pinia) and [Vue Router](/quasar-cli-vite-v2/routing) initialization functions, and to the [preFetch](/quasar-cli-vite-v2/prefetch-feature) method:
