...
desc: (legacy @quasar/app-vite v2) How to configure your Quasar server-side rendered app to become a Progressive Web App on the client side.
---
...
> For more information on PWA, head on to [PWA Introduction](/quasar-cli-vite-v2/developing-pwa/introduction) and read the whole PWA Guide section.
