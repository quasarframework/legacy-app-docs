...
desc: (legacy @quasar/app-vite v2) How to use analytics in a Quasar hybrid mobile app with Capacitor.
---
...
- Make sure all your routes have a name and path parameter specified. Otherwise, they cannot be posted to the `ga.logPage` function. Please refer to [Routing](/quasar-cli-vite-v2/routing) for more info on routing.
