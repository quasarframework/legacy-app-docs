---
title: App Routing
desc: (legacy @quasar/app-vite v2) How to use the Vue Router in a Quasar app.
---
...
::: tip
If you are developing a SSR app, then you can check out the [ssrContext](/quasar-cli-vite-v2/developing-ssr/ssr-context) Object that gets supplied server-side.
:::
