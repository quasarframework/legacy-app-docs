---
title: Deploying SSR
desc: (legacy @quasar/app-webpack v4) How to publish a Quasar server-side rendered app.
---
...
If you are deploying to a Serverless service, then please read about [SSR Production Export](/quasar-cli-webpack-v4/developing-ssr/ssr-production-export) on how to prepare for it.
