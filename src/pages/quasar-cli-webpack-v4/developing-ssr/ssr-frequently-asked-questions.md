...
The `ssrContext` is available in the [Boot Files](/quasar-cli-webpack-v4/boot-files) or the [PreFetch Feature](/quasar-cli-webpack-v4/prefetch-feature), where it is supplied as a parameter.
...
Also a good idea is to read the [Writing Universal Code](/quasar-cli-webpack-v4/developing-ssr/writing-universal-code) documentation page.
