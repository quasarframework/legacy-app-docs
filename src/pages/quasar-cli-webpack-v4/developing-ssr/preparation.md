...
desc: (legacy @quasar/app-webpack v4) How to add SSR mode with Quasar CLI.
related:
...
A new folder will appear in your project folder (which is explained in detail on the [Configuring SSR](/quasar-cli-webpack-v4/developing-ssr/configuring-ssr) page):
