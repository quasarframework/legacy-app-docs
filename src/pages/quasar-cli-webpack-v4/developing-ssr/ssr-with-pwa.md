...
desc: (legacy @quasar/app-webpack v4) How to configure your Quasar server-side rendered app to become a Progressive Web App on the client side.
---
...
> For more information on PWA, head on to [PWA Introduction](/quasar-cli-webpack-v4/developing-pwa/introduction) and read the whole PWA Guide section.
