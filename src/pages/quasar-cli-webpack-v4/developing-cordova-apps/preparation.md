...
desc: (legacy @quasar/app-webpack v4) What you need to do before developing a Quasar hybrid mobile app with Cordova.
---
...
You will be able to run the app on your mobile device if you have one, or through the emulator. See [Mobile App Build Commands > Developing](/quasar-cli-webpack-v4/developing-cordova-apps/build-commands#developing) for more information.
