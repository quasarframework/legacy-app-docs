...
desc: (legacy @quasar/app-webpack v4) Introduction on one of the technologies behind Quasar hybrid mobile apps.
---
...
You can hook into the native device APIs by using [Cordova Plugins](/quasar-cli-webpack-v4/developing-cordova-apps/cordova-plugins).
