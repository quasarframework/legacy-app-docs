---
title: Ajax Requests
desc: (legacy @quasar/app-webpack v4) Using Axios for fetching data in a Quasar app.
---
...
::: tip
Be sure to check out [Prefetch Feature](/quasar-cli-webpack-v4/prefetch-feature) if you are using Quasar CLI.
:::
