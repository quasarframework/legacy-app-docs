...
desc: (legacy @quasar/app-webpack v4) How to add PWA mode with Quasar CLI.
related:
...
A new folder will appear in your project folder (which is explained in detail on the [Configuring PWA](/quasar-cli-webpack-v4/developing-pwa/configuring-pwa) page):
