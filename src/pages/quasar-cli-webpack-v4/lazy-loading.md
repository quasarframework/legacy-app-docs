...
desc: (legacy @quasar/app-webpack v4) How to create Webpack chunks in a Quasar app.
---
...
For more details, see the [vendors section](/quasar-cli-webpack-v4/quasar-config-file#property-vendor) of the `/quasar.config` file.
