...
desc: (legacy @quasar/app-webpack v4) Introduction about the technology behind Quasar desktop apps.
---
...
The [preload script](/quasar-cli-webpack-v4/developing-electron-apps/electron-preload-script) (`/src-electron/electron-preload.js`) is a way for you to inject Node.js stuff into the renderer thread by using a bridge between it and the UI. You can expose APIs that you can then call from your UI.
