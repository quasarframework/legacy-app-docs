...
- If you have linting, please review your setup by going to [Linter page](/quasar-cli-webpack-v4/linter). You will need to:
...
async function createWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      // More info: https://v2.quasar.dev/quasar-cli-webpack-v4/developing-electron-apps/electron-preload-script
      preload: path.resolve(
        currentDir,
        path.join(
 ...
 * https://v2.quasar.dev/quasar-cli-webpack-v4/developing-ssr/ssr-webserver
 *
