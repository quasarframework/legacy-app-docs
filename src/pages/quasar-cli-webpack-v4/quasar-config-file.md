...
desc: (legacy @quasar/app-webpack v4) Where, how and what you can configure in a Quasar app.
---
...
- [Boot Files](/quasar-cli-webpack-v4/boot-files) list (that determines order of execution too) -- which are files in `/src/boot` that tell how your app is initialized before mounting the root Vue component
- Global CSS/Sass/... files to be included in the bundle
- PWA [manifest](/quasar-cli-webpack-v4/developing-pwa/configuring-pwa#Configuring-Manifest-File) and [Workbox options](/quasar-cli-webpack-v4/developing-pwa/configuring-pwa#quasar-config-file)
- [Electron Packager](/quasar-cli-webpack-v4/developing-electron-apps/configuring-electron#quasar-config-file) and/or [Electron Builder](/quasar-cli-webpack-v4/developing-electron-apps/configuring-electron#quasar-config-file)
...
More on [Boot Files](/quasar-cli-webpack-v4/boot-files).
...
More on the [PreFetch Feature](/quasar-cli-webpack-v4/prefetch-feature) page.
...
Please refer to [Adding to process.env](/quasar-cli-webpack-v4/handling-process-env#adding-to-process-env) section in our docs.

### Handling Webpack configuration

In depth analysis on [Handling Webpack](/quasar-cli-webpack-v4/handling-webpack) documentation page.
