---
title: App Routing
desc: (legacy @quasar/app-webpack v4) How to use the Vue Router in a Quasar app.
---
...
::: tip
If you are developing a SSR app, then you can check out the [ssrContext](/quasar-cli-webpack-v4/developing-ssr/ssr-context) Object that gets supplied server-side.
:::
