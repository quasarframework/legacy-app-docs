...
desc: (legacy @quasar/app-webpack v4) How to use analytics in a Quasar hybrid mobile app with Capacitor.
---
...
- Make sure all your routes have a name and path parameter specified. Otherwise, they cannot be posted to the `ga.logPage` function. Please refer to [Routing](/quasar-cli-webpack-v4/routing) for more info on routing.
