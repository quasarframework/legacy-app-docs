...
You might want to check the requirements for it [here](/quasar-cli-webpack-v4/linter).
...
If you are using [PWA mode](/quasar-cli-webpack-v4/developing-pwa/introduction), make the following modifications to your project, and create any files that do not exist:
...
If you are using [Electron mode](/quasar-cli-webpack-v4/developing-electron-apps/introduction), add the section below to your project.
