...
desc: (legacy @quasar/app-webpack v4) How to convert a Quasar CLI with Vite project to a Quasar CLI with Webpack one.
---
...
A Quasar CLI with Webpack project relies on `/package.json > browserslist` to specify which browsers you are targeting. More info: [Browser Compatibility](/quasar-cli-webpack-v4/browser-compatibility) page.
...
If you are using ESLint, you might want to check the requirements for it [here](/quasar-cli-webpack-v4/linter).
