...
function openGitHub () {
  openURL(`https://github.com/quasarframework/legacy-app-docs/tree/${ import.meta.env.DOCS_BRANCH }/src/examples/${ examples.name }/${ props.file }.vue`)
}
...
import.meta.env.QUASAR_CLIENT && onMounted(() => {
